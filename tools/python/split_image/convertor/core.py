...
class Convertor(object):
    ...
    def __init__(self, path, outDir, config=FLAG.CF_INDEXED_4_BIT, dith=True):
        ...
        self.out_dir = outDir  # dir of the output file
...
const lv_img_dsc_t {self.out_name} = {{
  ...
  .data_size = '''
    ...
    def get_bin_file(self, cf=-1, content=None) -> bytes:
        ...
        out_path = os.path.join(self.out_dir, self.out_name + ".bin")
